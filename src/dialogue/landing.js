...
// <<useYarnCodeNode>> / <<useWavyNode>> toggle custom presentation (see OneMessageNode + DialogueSection).
export const landingDialogue = `
title: Start
---
Welcome! Explore the creations of developer Matthew Broatch
...
title: TellMeMore
---
All right! So there's this language for making videogame-style dialogues, called Yarn.
<<useYarnCodeNode>>
It looks like this:
  -> Oooh, this!
<<useCustomNode>>
Matthew Broatch did a full rewrite of the JavaScript Yarn interpreter to bring it from version 1.0 to version 2.0, and created a user-friendly API for it called YarnBound.
...
Oh, and don't forget to download a resume... Matthew is looking for work!
===
`
