...
const YARNBOUND_GITHUB = 'https://github.com/mnbroatch/yarn-bound'
  ...
  return (
    <div className="section-technical one-message-node__tech-specs">
      ...
      <p className="section-technical-links">
        <a
          href={YARNBOUND_GITHUB}
          target="_blank"
          rel="noopener noreferrer"
          className="section-technical-links__github"
        >
          <GithubMark className="section-technical-links__github-mark" />
          yarn-bound
        </a>
        {' · '}
        <a
          href={REACT_DIALOGUE_TREE_GITHUB}
          target="_blank"
          rel="noopener noreferrer"
          className="section-technical-links__github"
        >
